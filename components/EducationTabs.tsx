    ...
    return (
        ...
        >
            <TabsList
                ...
                className="
          w-full max-w-6xl mx-auto flex gap-2 sm:gap-4
          bg-transparent border-none overflow-x-auto sm:overflow-visible
          px-1 sm:px-0 rounded-none scrollbar-none snap-x snap-mandatory
          mb-6 sm:mb-12
        "
            >
                {TAB_TYPES.map((type) => (
            ...
            {TAB_TYPES.map((type) => (
                <TabsContent
                    key={type}
                    value={type}
                    className="px-1 sm:px-0 mt-4 sm:mt-8"
                >
                    <AnimatePresence mode="wait">
                        {tab === type && (
                            <motion.div
