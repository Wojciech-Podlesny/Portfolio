    ...
    return (
        <section
            ...
            className="px-4 py-12 md:px-12
                bg-gradient-to-b from-white to-zinc-100 dark:from-[#0c0f14] dark:to-[#151a23]
        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:justify-between gap-12 md:mx-16">
                ...
                <motion.div
                    ...
                    className="w-full md:w-1/2 flex justify-center"
                >
                    <div className="rounded-xl shadow-lg overflow-hidden max-w-full border border-zinc-300 dark:border-zinc-700 h-fit">
                        <CodeBlocks />
                    </div>
                </motion.div>
            </div>
