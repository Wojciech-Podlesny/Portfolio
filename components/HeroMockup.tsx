...
export function HeroMockup({ src, alt }: { src?: Img; alt: string }) {
    ...
    return (
        <div className="max-w-5xl mx-auto px-6 mb-16">
            <div className="relative mx-auto w-full rounded-2xl overflow-hidden h-[28rem] md:h-[40rem]
                bg-white ring-1 ring-black/10 dark:bg-gray-900 dark:ring-white/10 transition-colors duration-300">
                <Image
                    src={src}
                    alt={alt}
                    fill
