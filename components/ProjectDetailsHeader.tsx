...
export const ProjectDetailsHeader = ({title, date, status, preview, github,}: ProjectDetailsHeaderProps) => {
    return (
        <header className="flex flex-col items-center text-center px-4 pt-48 pb-24">
            <h1
                id="project-title"
